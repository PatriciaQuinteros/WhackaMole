...
game.drawBackground = function()
{
   ...
   //indicates new path being drawn
  atom.context.beginPath();
  //sets the fill style to blue 
  atom.context.fillStyle = '#34e';

  //fill in top half with position cordinates 
  atom.context.fillRect(0, 0, atom.width, atom.height/2);

  //change to yellow to make sun
  atom.context.fillStyle = '#ee3';

  //describe circle with positions, angle and radius
  atom.context.arc(140, atom.height/2 -30, 90, Math.PI*2, 0); 
  atom.context.fill();

  //draw ground similar to sky
